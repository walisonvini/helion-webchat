              ...
              <form @submit.prevent="submitForm(form)">
                <div class="flex -mx-3">
                  <div class="w-full px-3 mb-5">
                    <label for="" class="text-xs font-semibold px-1">Email ou nome de Usuário</label>
                    <div class="flex">
                      <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-email-outline text-gray-400 text-lg"></i></div>
                      <input type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" :class="{ 'border-red-400': form.username.invalidFeedback }" v-model="form.username.value" placeholder="johnsmith@example.com">
                    </div>
                  </div>
                </div>
                  <div class="flex -mx-3">
